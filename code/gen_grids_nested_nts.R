...
nx <- 3 # number of nested grids e.g., 10 x 10
output <- 'data/yt_priority_nts_n3.shp'
...
nts <- st_read('C:/Users/PIVER37/Documents/gisdata/123/yt_disturbance_mapping.gdb','Priority_NTS_50k')
